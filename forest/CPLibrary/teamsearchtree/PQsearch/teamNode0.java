...
public class teamNode0 implements Comparable<teamNode0>{
	...
	public teamNode0(String name, List<Double> resources){
		this.name = name;
	...
	public teamNode0(String name, teamNode parent, int resourceindex){
		this.name = name;
		if(parent == null){
			for(int i=0; i<3; i++)
				resources[i] = 0; 
	...
	@Override
	public int compareTo(teamNode0 o) {
		final int BEFORE = 1;
	    final int EQUAL = 0;
	    final int AFTER = -1;
