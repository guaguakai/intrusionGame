...
//		}
 ...
 public static String BruteForce(AbstractBaseGraph graph, double budget) throws MalformedGraphException, LPSolverException{
	...
	public static String PQSearch(AbstractBaseGraph graph, double budget, int t) throws MalformedGraphException, LPSolverException{
	...
	public static void main(String[] args) throws MalformedGraphException, LPSolverException ,FileNotFoundException{
		...
		//AbstractBaseGraph graph = RandomGraph( 50, 4, 4, 0.2);
		

		//AbstractBaseGraph graph = genLargeTestGraph();
		AbstractBaseGraph graph = GridGraph(3,3,3,3,50);
		...
		List<Double> resources2 = new ArrayList<Double>();
		resources2.add(2.0);
		

		List<Double> coverage2 = new ArrayList<Double>();
		coverage2.add(3.0);
		...
		//testCompactProblem(graph,resources, coverage, null,null);
		//getBestResponsePaths(graph, resources, coverage, null);
		//testCompactProblem(graph,resources, coverage, null,getBestResponsePaths(graph, resources, coverage, null));
...
//		GraphVisual g2 = new GraphVisual(graph);
//		g2.run();
		...
		//testQuickSolve(graph,null);
		testBetterRespt(graph,args, 0, null, false);
		//testBetterRespt(graph,args, 0, null, true);
		//testBetterRespPROBS(graph,args);
		//testBetterRespPROBS2(graph,args);

		
//		int [] resourcecost = {5, 8, 10, 5, 8, 10};
//		int [] resourcecoverage = {2, 3, 5, 3, 3, 6};
//		double [] resourceprob = {0.7, 0.9, 0.7, 0.6, 0.6, 0.6};
		
		
		int [] resourcecost = {5, 6, 7};
		int [] resourcecoverage = {2, 3, 4};
		//int [] resourcecoverage = {2, 2, 2, 2};
		double [] resourceprob = {0.5,0.6, 0.7};
...
//		double [] resourceprob = {0.7,0.6, 0.9, 0.8};
		...
		teamNode.setTeams(resourcecost, resourcecoverage, resourceprob, false);
		//testAttacker(graph, 15);
		
		
//		String results = PQSearch(graph, 20, 1);
//		
//		try {
//		    PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("TeamComp.csv", true)));
...
//		
		...
		if(true){
		int budget  = 15;
		//subSearch(graph, budget, 0);
		PQSearch(graph, budget, 1);
		
		//System.out.println("-----------");
		//PQSearch(graph, budget, 2);
		System.out.println("-----------");
		//smartBruteForce(graph, budget);
