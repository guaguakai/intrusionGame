...
%
% x = cplexmiqcp(H,f,Aineq,bineq,Aeq,beq,l,Q,r,sostype,sosind,soswt,lb,ub,
% ctype,x0,options) minimizes with the default optimization options
% replaced by values in the structure options, which
% can be created using the function cplexoptimset If you do not want to
