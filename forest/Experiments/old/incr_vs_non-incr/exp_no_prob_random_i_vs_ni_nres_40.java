...
public class exp_no_prob_random_i_vs_ni_nres_40 {
			...
			for(int ii=0;ii<25;ii++){
				...
				try {
					PrintWriter out_non_incremental = new PrintWriter(new BufferedWriter(new FileWriter(
							"results_no_prob_random_non_incr_nresources_"+resourcecost.length+"_budget_"+budget+".csv", true)));
				...
				try {
					PrintWriter out_incremental = new PrintWriter(new BufferedWriter(new FileWriter(
							"results_no_prob_random_incr_nresources_"+resourcecost.length+"_budget_"+budget+".csv", true)));
					//out.print(budget + ", " + graph.vertexSet().size() + ", "+graph.edgeSet().size());
