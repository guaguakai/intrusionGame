...
public class SaraCompareSolvers {
	...
	public static String HeuristicGuarantee(AbstractBaseGraph graph, int budget, int[] resourcecoverage, double[] resourceprob, int[] resourcecost){
		...
		String results = budget +", "+root.getEvaluation() + ", "+(tock_guar-tick_guar)/1000 + ", "
	...
	public static String HeuristicFast(AbstractBaseGraph graph, int budget, int[] resourcecoverage, double[] resourceprob, int[] resourcecost){
		...
		String results = budget +", "+root.getEvaluation() + ", "+(tock_fast-tick_fast)/1000 + ", " 
				+root.resourcesList.get(0)+", "+root.resourcesList.get(1)+", "+root.resourcesList.get(2)+", "
				+root.resourcesList.get(3)+", "+root.resourcesList.get(4)+", "+root.resourcesList.get(5)+", "
				+Integer.toString(tot_cost[0])+", "+Integer.toString(tot_cost[1])+", "+Integer.toString(tot_cost[2])+", "
				+Integer.toString(tot_cost[3])+", "+Integer.toString(tot_cost[4])+", "+Integer.toString(tot_cost[5])+", "
	...
	public static void main(String[] args) throws MalformedGraphException, LPSolverException ,FileNotFoundException{
		...
		for(;budget<26;budget+=10){		
			//Call to the "fast" algorithm: comment until "end commenting" if you do not want to run it
			...
			try {
				PrintWriter out_fast = new PrintWriter(new BufferedWriter(new FileWriter(
						"results_with_prob_grid_fast_why.csv", true)));
			...
			//Call to the approximation algorithm: comment until "end commenting" if you do not want to run it
			...
			try {
				PrintWriter out_guarantee = new PrintWriter(new BufferedWriter(new FileWriter(
						"results_with_prob_grid_guarantee_why.csv", true)));
			...
			//Call to the PQSearch: comment until "end commenting" if you do not want to run it
			...
			try {
				PrintWriter out_opt = new PrintWriter(new BufferedWriter(new FileWriter(
						"results_with_prob_grid_opt_why.csv", true)));
